package by.belstu.it.Ermakov.Basejava;
...
public class JavaTest {
   ...
   public static class WrapperString {
        ...
        public WrapperString(String stor) {
            this.stor = stor;
        }
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(stor, that.stor);
        }

        @Override
        public int hashCode() {

            return Objects.hash(stor);
        }
...
System.out.println(oldchar+newchar);
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        final double max = 1.0; // Максимальное число для диапазона
...
//выше мы создали класс с разными методами
         WrapperString asd=new WrapperString();
         asd.replace("PA", "PA");
    }
