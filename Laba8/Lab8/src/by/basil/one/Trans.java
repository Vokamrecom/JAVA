...
public class Trans {
        ...
        public static void main(String[] args) throws ClassNotFoundException, SQLException {
            ...
            statement = connection.createStatement();// Создание  объекта  для  передачи  запросов

            String SQL;
            SQL = "SELECT * FROM author";

            ResultSet resultSet = statement.executeQuery(SQL);//ResultSet содержит все строки, удовлетворяющие условиям в SQL-выражении в столбике
